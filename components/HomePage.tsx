...
export const HomePage: React.FC = () => {
  ...
  // First product is featured if available
      ...
      <section className="bg-white pt-24 pb-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl sm:text-2xl text-[#86868b] max-w-2xl mx-auto leading-relaxed font-normal tracking-tight">
            The Lumina internal ecosystem. <br className="hidden sm:block"/> Empowering teams to build the future.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-32">
            <p className="text-gray-400 text-lg font-light">No products available in this category.</p>
          </div>
        )}
      </section>
    </div>
